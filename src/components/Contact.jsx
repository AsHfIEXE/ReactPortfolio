        ...
        <div className="contact-container">
          <div className="contact-info reveal">
            ...
            <div className="social-grid">
              ...
              <a href="https://hackerone.com/ashfi" className="social-link" title="HackerOne" style={{color: '#fff'}} target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://books2read.com/u/bxP87E" className="social-link" title="Books2Read" style={{color: '#a855f7'}} target="_blank" rel="noopener noreferrer">
